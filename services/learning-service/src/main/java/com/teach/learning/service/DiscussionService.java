...
public class DiscussionService {
    ...
    public DiscussionService(DiscussionPostMapper postMapper, DiscussionReplyMapper replyMapper) {
        this.postMapper = postMapper; this.replyMapper = replyMapper;
    }
    ...
    public DiscussionReply createReply(Long postId, Long userId, String content, Boolean anonymous, Boolean assistantReply) {
        ...
        replyMapper.insert(reply); return reply;
    }
