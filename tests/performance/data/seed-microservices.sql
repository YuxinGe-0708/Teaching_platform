...
INSERT INTO `user` (id, username, password, role, name, email, status)
VALUES
 (900001, 'perf_student', @pwd, 'student', 'Performance Student', 'perf_student@example.com', 1),
 (900002, 'perf_teacher', @pwd, 'teacher', 'Performance Teacher', 'perf_teacher@example.com', 1)
ON DUPLICATE KEY UPDATE
 password=VALUES(password), role=VALUES(role), name=VALUES(name), email=VALUES(email), status=1;
