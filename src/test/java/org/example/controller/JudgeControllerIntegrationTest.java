...
class JudgeControllerIntegrationTest {
  ...
  void setUp() {
    ...
    User teacher = userService.register("judge_teacher", "password123", "teacher", "评测教师");
    Course course = new Course();
    course.setName("判题测试课程");
    course.setCode("JUDGE-" + System.nanoTime());
    course.setDescription("JudgeControllerIntegrationTest");
    course.setCredits(3);
    course.setSubjectCategory("测试");
    course.setHours(32);
    course.setTeacherId(teacher.getId());
    course.setAllowJoin(true);
    ...
    testTask.setCourseId(course.getId());
